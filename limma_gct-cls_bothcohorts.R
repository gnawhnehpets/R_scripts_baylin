...
create_gct(dat, "bothcohorts_expdat_remove2samp.gct", col)
...
create_cls(cls, "bothcohorts_expdat_remove2samp.cls")
...
#targets$Cy3_Sample[!is.na(match(targets$Cy3_Sample, s))]
#targets$Cy3_Sample[!is.na(match(targets$Cy3_Sample, s))]
s
...
create_gct(dat, "bothcohorts_expdat_remove2samp_pairsonly.gct", col)
...
create_cls(cls, "bothcohorts_expdat_remove2samp_pairsonly.cls")
